...
const OwnerProfile = () => {
  ...
  const handleProfileUpdate = async () => {
    try {
      ...
      const {data} = await axios.put(backendUrl + '/api/owner/profile', user)
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      const {data} = await axios.put(backendUrl + '/api/owner/change-password', {oldPassword, newPassword})
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const {data} = await axios.delete(backendUrl + '/api/owner/delete-account');
